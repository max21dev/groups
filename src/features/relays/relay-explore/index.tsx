...
import { useRelayExplore } from './hooks';

export const RelayExplore = ({ activeRelay }: { activeRelay: string | undefined }) => {
  const {
    events,
    isInitialLoading,
        ...
        <div className="w-full max-w-2xl flex items-center justify-between my-2">
          <Popover open={isPopoverOpen} onOpenChange={handlePopoverOpenChange}>
            ...
            <PopoverContent className="w-80 max-h-96 overflow-y-auto">
              ...
              <ScrollArea viewportProps={{ className: 'max-h-64' }}>
